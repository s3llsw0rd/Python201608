...
#!!!!!STRUGGLING WITH THE DIFFERENCE BETWEEN LEFT JOIN AND JOIN. BOTH RETURN THE SAME RESULT HERE!!!!!
...
SELECT countries.region, COUNT(countries.id) AS country_number
FROM countries
